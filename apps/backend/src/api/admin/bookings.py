...
async def list_bookings(
    ...
    _: dict = Depends(get_current_active_user(required_permissions=[RolePermission.MANAGE_BOOKINGS]))
):
    """
...
async def update_booking(
    ...
    booking_id: int = Path(..., description="ID бронирования"),
    db: AsyncSession = Depends(get_db),
    current_user: dict = Depends(get_current_active_user(required_permissions=[RolePermission.MANAGE_BOOKINGS]))
):
    """
