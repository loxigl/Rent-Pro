...
from src.middleware.auth import get_current_active_user, RolePermission
...
async def get_system_settings(
    ...
    _: dict = Depends(get_current_active_user(required_permissions=[RolePermission.MANAGE_SETTINGS]))
):
    """
...
async def update_system_settings(
    ...
    db: AsyncSession = Depends(get_db),
    current_user: dict = Depends(get_current_active_user(required_permissions=[RolePermission.MANAGE_SETTINGS]))
):
    """
